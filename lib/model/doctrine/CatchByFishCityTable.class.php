...
/**
 * CatchByFishCityTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class CatchByFishCityTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object CatchByFishCityTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('CatchByFishCity');
    }

    public function fishByCity($state,$city,$limit = 50){
      $q = Doctrine_Query::create()
	->select('c.count_fish,c.fish_id,c.name,c.name_sci,c.rate,c.count_fish,c.avg_weight,c.avg_length')
	->from('CatchByFishCity c')
	->where('c.state = ?',$state)
