...
Doctrine_Manager::getInstance()->bindComponent('FishForBlog', 'doctrine-discuss');
 ...
 * @method FishForBlog         setPid()     Sets the current record's "pid" value
 * @method FishForBlog         setFishId()  Sets the current record's "fish_id" value
 * @method FishForBlog         setBlog()    Sets the current record's "Blog" collection
 * @method FishForBlog         setFish()    Sets the current record's "Fish" collection
 * 
 * @package    fb
 * @subpackage model
 ...
 */
abstract class BaseFishForBlog extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('fish_for_blog');
