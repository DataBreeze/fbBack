...
class BlogReplyTable extends Doctrine_Table{

  public static function getInstance(){
    return Doctrine_Core::getTable('BlogReply');
  }
  ...
  public function getReplies($pid,$limit = BlogReplyTable::REPLY_RECORD_LIMIT,$offset = 0){
    ...
    $q = Doctrine_Query::create()
      ...
      ->limit($limit);
    if($offset > 0){
      $q->offset($offset * BlogReplyTable::REPLY_RECORD_LIMIT);
    }
    $rows = $q->execute(array(),Doctrine_Core::HYDRATE_SCALAR);
    $recs = array();
